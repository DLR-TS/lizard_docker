...
.PHONY: lizard
lizard: build_fast check_CPP_PROJECT_DIRECTORY ## generate lizard report for provided source directory. Call with: make lizard CPP_PROJECT_DIRECTORY=/absolute/path/to/source 
